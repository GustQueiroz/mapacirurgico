...
namespace Dex.MapaCirurgico.Migrations
{
    ...
    [Migration("20190105211825_ConvenioAgendamentoMig")]
    partial class ConvenioAgendamentoMig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dex.MapaCirurgico.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Dex.MapaCirurgico.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Dex.MapaCirurgico.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Dex.MapaCirurgico.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Dex.MapaCirurgico.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Dex.MapaCirurgico.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Dex.MapaCirurgico.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Dex.MapaCirurgico.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Dex.MapaCirurgico.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
